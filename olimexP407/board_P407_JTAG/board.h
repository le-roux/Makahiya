...
#define VAL_GPIOB_MODER     (PIN_MODE_OUTPUT(GPIOB_LCD_BL) |                \
                             ...
                             PIN_MODE_ALTERNATE(GPIOB_LED_RED) |            \
 ...
 * PC13 - GPIOC_BUTTON_TAMPER   (input).
 ...
 * PF8  - GPIOF_STAT3           (alternate 9).
 * PF9  - GPIOF_STAT4           (alternate 9).
...
#define VAL_GPIOF_MODER     (PIN_MODE_INPUT(GPIOF_0) |                      \
                             ...
                             PIN_MODE_ALTERNATE(GPIOF_STAT3) |              \
                             PIN_MODE_ALTERNATE(GPIOF_STAT4) |              \
